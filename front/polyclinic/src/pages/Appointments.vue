...
import AppointmentEditModal from '@/pages/Appointment/AppointmentEditModal.vue'
import AppointmentDeleteModal from '@/pages/Appointment/AppointmentDeleteModal.vue'
...
<template>
  <div class="max-w-7xl mx-auto p-8 flex flex-col gap-10">
    <div class="flex justify-between items-center">
      <h1 class="text-4xl font-extrabold text-teal-800 tracking-tight">Все записи</h1>
    </div>
